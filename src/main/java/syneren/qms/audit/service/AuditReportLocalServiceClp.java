 ...
 * @generated
 */
public class AuditReportLocalServiceClp implements AuditReportLocalService {
    ...
    public AuditReportLocalServiceClp(
    ...
    public syneren.qms.audit.model.AuditReport addAuditReport(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(auditReport) });
        } catch (Throwable t) {
        ...
        return (syneren.qms.audit.model.AuditReport) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public syneren.qms.audit.model.AuditReport getAuditReport(long AuditId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { AuditId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<syneren.qms.audit.model.AuditReport> getAuditReports(
        ...
        return (java.util.List<syneren.qms.audit.model.AuditReport>) ClpSerializer.translateOutput(returnObj);
    }
