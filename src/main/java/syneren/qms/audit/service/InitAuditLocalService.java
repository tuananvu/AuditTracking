...
/**
 * Provides the local service interface for InitAudit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author anguyen
 * @see InitAuditLocalServiceUtil
...
public interface InitAuditLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link InitAuditLocalServiceUtil} to access the init audit local service. Add custom service methods to {@link syneren.qms.audit.service.impl.InitAuditLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
