...
/**
 * Provides the local service interface for AuditCheckItem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author anguyen
 * @see AuditCheckItemLocalServiceUtil
...
public interface AuditCheckItemLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link AuditCheckItemLocalServiceUtil} to access the audit check item local service. Add custom service methods to {@link syneren.qms.audit.service.impl.AuditCheckItemLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
