...
/**
 * Provides the local service interface for AuditPlan. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author anguyen
 * @see AuditPlanLocalServiceUtil
...
public interface AuditPlanLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link AuditPlanLocalServiceUtil} to access the audit plan local service. Add custom service methods to {@link syneren.qms.audit.service.impl.AuditPlanLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
