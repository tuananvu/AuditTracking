...
/**
 * Provides the local service interface for AuditFinding. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author anguyen
 * @see AuditFindingLocalServiceUtil
...
public interface AuditFindingLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link AuditFindingLocalServiceUtil} to access the audit finding local service. Add custom service methods to {@link syneren.qms.audit.service.impl.AuditFindingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
