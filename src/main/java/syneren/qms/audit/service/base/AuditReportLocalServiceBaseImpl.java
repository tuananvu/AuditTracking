...
import syneren.qms.audit.service.AuditReportLocalService;
...
/**
 * Provides the base implementation for the audit report local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link syneren.qms.audit.service.impl.AuditReportLocalServiceImpl}.
 * </p>
 *
 * @author anguyen
 ...
 * @generated
 */
public abstract class AuditReportLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements AuditReportLocalService,
        IdentifiableBean {
    ...
    private AuditReportLocalServiceClpInvoker _clpInvoker = new AuditReportLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link syneren.qms.audit.service.AuditReportLocalServiceUtil} to access the audit report local service.
     */
    ...
    @Override
    public AuditReport addAuditReport(AuditReport auditReport)
        throws SystemException {
        auditReport.setNew(true);

        return auditReportPersistence.update(auditReport);
    }
     ...
     */
    @Override
    public AuditReport createAuditReport(long AuditId) {
        return auditReportPersistence.create(AuditId);
    }
    ...
    @Override
    public AuditReport deleteAuditReport(long AuditId)
        throws PortalException, SystemException {
        return auditReportPersistence.remove(AuditId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public AuditReport deleteAuditReport(AuditReport auditReport)
        throws SystemException {
        return auditReportPersistence.remove(auditReport);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(AuditReport.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return auditReportPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return auditReportPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return auditReportPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public AuditReport fetchAuditReport(long AuditId) throws SystemException {
        return auditReportPersistence.fetchByPrimaryKey(AuditId);
    }
    ...
    public AuditReport getAuditReport(long AuditId)
        throws PortalException, SystemException {
        return auditReportPersistence.findByPrimaryKey(AuditId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return auditReportPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<AuditReport> getAuditReports(int start, int end)
        throws SystemException {
        return auditReportPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getAuditReportsCount() throws SystemException {
        return auditReportPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public AuditReport updateAuditReport(AuditReport auditReport)
        throws SystemException {
        return auditReportPersistence.update(auditReport);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("syneren.qms.audit.model.AuditReport",
            auditReportLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = auditReportPersistence.getDataSource();
