...
import syneren.qms.audit.service.CorrectiveActionLocalService;
...
/**
 * Provides the base implementation for the corrective action local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link syneren.qms.audit.service.impl.CorrectiveActionLocalServiceImpl}.
 * </p>
 *
 * @author anguyen
 * @see syneren.qms.audit.service.impl.CorrectiveActionLocalServiceImpl
 * @see syneren.qms.audit.service.CorrectiveActionLocalServiceUtil
 * @generated
 */
public abstract class CorrectiveActionLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements CorrectiveActionLocalService,
        IdentifiableBean {
    ...
    private CorrectiveActionLocalServiceClpInvoker _clpInvoker = new CorrectiveActionLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link syneren.qms.audit.service.CorrectiveActionLocalServiceUtil} to access the corrective action local service.
     */
    ...
    public CorrectiveAction addCorrectiveAction(
        CorrectiveAction correctiveAction) throws SystemException {
        correctiveAction.setNew(true);

        return correctiveActionPersistence.update(correctiveAction);
    }
     ...
     */
    @Override
    public CorrectiveAction createCorrectiveAction(long ActionId) {
        return correctiveActionPersistence.create(ActionId);
    }
    ...
    @Override
    public CorrectiveAction deleteCorrectiveAction(long ActionId)
        throws PortalException, SystemException {
        return correctiveActionPersistence.remove(ActionId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public CorrectiveAction deleteCorrectiveAction(
        CorrectiveAction correctiveAction) throws SystemException {
        return correctiveActionPersistence.remove(correctiveAction);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(CorrectiveAction.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return correctiveActionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return correctiveActionPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public CorrectiveAction fetchCorrectiveAction(long ActionId)
        throws SystemException {
        return correctiveActionPersistence.fetchByPrimaryKey(ActionId);
    }
     ...
     */
    @Override
    public CorrectiveAction getCorrectiveAction(long ActionId)
        throws PortalException, SystemException {
        return correctiveActionPersistence.findByPrimaryKey(ActionId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return correctiveActionPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<CorrectiveAction> getCorrectiveActions(int start, int end)
        throws SystemException {
        return correctiveActionPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getCorrectiveActionsCount() throws SystemException {
        return correctiveActionPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public CorrectiveAction updateCorrectiveAction(
        CorrectiveAction correctiveAction) throws SystemException {
        return correctiveActionPersistence.update(correctiveAction);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("syneren.qms.audit.model.CorrectiveAction",
            correctiveActionLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = correctiveActionPersistence.getDataSource();
