...
import syneren.qms.audit.service.InitAuditLocalService;
...
/**
 * Provides the base implementation for the init audit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link syneren.qms.audit.service.impl.InitAuditLocalServiceImpl}.
 * </p>
 *
 * @author anguyen
 ...
 * @generated
 */
public abstract class InitAuditLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements InitAuditLocalService, IdentifiableBean {
    ...
    private InitAuditLocalServiceClpInvoker _clpInvoker = new InitAuditLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link syneren.qms.audit.service.InitAuditLocalServiceUtil} to access the init audit local service.
     */
    ...
    @Override
    public InitAudit addInitAudit(InitAudit initAudit)
        throws SystemException {
        initAudit.setNew(true);

        return initAuditPersistence.update(initAudit);
    }
     ...
     */
    @Override
    public InitAudit createInitAudit(long InitAuditId) {
        return initAuditPersistence.create(InitAuditId);
    }
    ...
    @Override
    public InitAudit deleteInitAudit(long InitAuditId)
        throws PortalException, SystemException {
        return initAuditPersistence.remove(InitAuditId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public InitAudit deleteInitAudit(InitAudit initAudit)
        throws SystemException {
        return initAuditPersistence.remove(initAudit);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(InitAudit.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return initAuditPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return initAuditPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return initAuditPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public InitAudit fetchInitAudit(long InitAuditId) throws SystemException {
        return initAuditPersistence.fetchByPrimaryKey(InitAuditId);
    }
     ...
     */
    @Override
    public InitAudit getInitAudit(long InitAuditId)
        throws PortalException, SystemException {
        return initAuditPersistence.findByPrimaryKey(InitAuditId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return initAuditPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<InitAudit> getInitAudits(int start, int end)
        throws SystemException {
        return initAuditPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getInitAuditsCount() throws SystemException {
        return initAuditPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public InitAudit updateInitAudit(InitAudit initAudit)
        throws SystemException {
        return initAuditPersistence.update(initAudit);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("syneren.qms.audit.model.InitAudit",
            initAuditLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = initAuditPersistence.getDataSource();
