...
import syneren.qms.audit.service.AuditPlanLocalService;
...
/**
 * Provides the base implementation for the audit plan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link syneren.qms.audit.service.impl.AuditPlanLocalServiceImpl}.
 * </p>
 *
 * @author anguyen
 ...
 * @generated
 */
public abstract class AuditPlanLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements AuditPlanLocalService, IdentifiableBean {
    ...
    private AuditPlanLocalServiceClpInvoker _clpInvoker = new AuditPlanLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link syneren.qms.audit.service.AuditPlanLocalServiceUtil} to access the audit plan local service.
     */
    ...
    public AuditPlan addAuditPlan(AuditPlan auditPlan)
        ...
        return auditPlanPersistence.update(auditPlan);
    }
     ...
     */
    @Override
    public AuditPlan createAuditPlan(long PlanId) {
        return auditPlanPersistence.create(PlanId);
    }
    ...
    @Override
    public AuditPlan deleteAuditPlan(long PlanId)
        throws PortalException, SystemException {
        return auditPlanPersistence.remove(PlanId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public AuditPlan deleteAuditPlan(AuditPlan auditPlan)
        throws PortalException, SystemException {
        return auditPlanPersistence.remove(auditPlan);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(AuditPlan.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return auditPlanPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return auditPlanPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return auditPlanPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public AuditPlan fetchAuditPlan(long PlanId) throws SystemException {
        return auditPlanPersistence.fetchByPrimaryKey(PlanId);
    }
     ...
     */
    @Override
    public AuditPlan getAuditPlan(long PlanId)
        throws PortalException, SystemException {
        return auditPlanPersistence.findByPrimaryKey(PlanId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return auditPlanPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<AuditPlan> getAuditPlans(int start, int end)
        throws SystemException {
        return auditPlanPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getAuditPlansCount() throws SystemException {
        return auditPlanPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public AuditPlan updateAuditPlan(AuditPlan auditPlan)
        throws SystemException {
        return auditPlanPersistence.update(auditPlan);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("syneren.qms.audit.model.AuditPlan",
            auditPlanLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = auditPlanPersistence.getDataSource();
