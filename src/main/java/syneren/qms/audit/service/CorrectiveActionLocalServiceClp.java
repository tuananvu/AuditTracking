 ...
 * @generated
 */
public class CorrectiveActionLocalServiceClp
    ...
    public CorrectiveActionLocalServiceClp(
    ...
    public syneren.qms.audit.model.CorrectiveAction addCorrectiveAction(
        ...
        return (syneren.qms.audit.model.CorrectiveAction) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public syneren.qms.audit.model.CorrectiveAction getCorrectiveAction(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { ActionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<syneren.qms.audit.model.CorrectiveAction> getCorrectiveActions(
        ...
        return (java.util.List<syneren.qms.audit.model.CorrectiveAction>) ClpSerializer.translateOutput(returnObj);
    }
