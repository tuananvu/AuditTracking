...
public class AuditReportPersistenceImpl extends BasePersistenceImpl<AuditReport>
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_I = new FinderPath(AuditReportModelImpl.ENTITY_CACHE_ENABLED,
            AuditReportModelImpl.FINDER_CACHE_ENABLED, AuditReportImpl.class,
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_I = new FinderPath(AuditReportModelImpl.ENTITY_CACHE_ENABLED,
            AuditReportModelImpl.FINDER_CACHE_ENABLED, AuditReportImpl.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_I",
            new String[] { Long.class.getName(), Long.class.getName() },
            AuditReportModelImpl.GROUPID_COLUMN_BITMASK |
            AuditReportModelImpl.INITAUDITID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_G_I = new FinderPath(AuditReportModelImpl.ENTITY_CACHE_ENABLED,
            AuditReportModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_I",
            new String[] { Long.class.getName(), Long.class.getName() });
    private static final String _FINDER_COLUMN_G_I_GROUPID_2 = "auditReport.groupId = ? AND ";
    private static final String _FINDER_COLUMN_G_I_INITAUDITID_2 = "auditReport.InitAuditId = ?";
     ...
     */
    @Override
    public List<AuditReport> findByG_I(long groupId, long InitAuditId)
        throws SystemException {
        return findByG_I(groupId, InitAuditId, QueryUtil.ALL_POS,
    ...
    public List<AuditReport> findByG_I(long groupId, long InitAuditId,
        ...
        return findByG_I(groupId, InitAuditId, start, end, null);
    }
    ...
    public List<AuditReport> findByG_I(long groupId, long InitAuditId,
        ...
        if ((list != null) && !list.isEmpty()) {
            for (AuditReport auditReport : list) {
                if ((groupId != auditReport.getGroupId()) ||
                        (InitAuditId != auditReport.getInitAuditId())) {
                    list = null;
        ...
        if (list == null) {
            ...
            query.append(_FINDER_COLUMN_G_I_INITAUDITID_2);
     ...
     */
    @Override
    public AuditReport findByG_I_First(long groupId, long InitAuditId,
        OrderByComparator orderByComparator)
        throws NoSuchAuditReportException, SystemException {
        AuditReport auditReport = fetchByG_I_First(groupId, InitAuditId,
                orderByComparator);
     ...
     */
    @Override
    public AuditReport fetchByG_I_First(long groupId, long InitAuditId,
        OrderByComparator orderByComparator) throws SystemException {
        List<AuditReport> list = findByG_I(groupId, InitAuditId, 0, 1,
                orderByComparator);
     ...
     */
    @Override
    public AuditReport findByG_I_Last(long groupId, long InitAuditId,
        OrderByComparator orderByComparator)
        throws NoSuchAuditReportException, SystemException {
        AuditReport auditReport = fetchByG_I_Last(groupId, InitAuditId,
                orderByComparator);
     ...
     */
    @Override
    public AuditReport fetchByG_I_Last(long groupId, long InitAuditId,
        OrderByComparator orderByComparator) throws SystemException {
        int count = countByG_I(groupId, InitAuditId);

        if (count == 0) {
            return null;
        }

        List<AuditReport> list = findByG_I(groupId, InitAuditId, count - 1,
     ...
     */
    @Override
    public AuditReport[] findByG_I_PrevAndNext(long AuditId, long groupId,
        ...
        try {
            ...
            array[0] = getByG_I_PrevAndNext(session, auditReport, groupId,
                    InitAuditId, orderByComparator, true);

            array[1] = auditReport;

            array[2] = getByG_I_PrevAndNext(session, auditReport, groupId,
    ...
    protected AuditReport getByG_I_PrevAndNext(Session session,
        AuditReport auditReport, long groupId, long InitAuditId,
        OrderByComparator orderByComparator, boolean previous) {
        StringBundler query = null;
     ...
     */
    @Override
    public void removeByG_I(long groupId, long InitAuditId)
        throws SystemException {
        for (AuditReport auditReport : findByG_I(groupId, InitAuditId,
                QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
            remove(auditReport);
        }
    }
     ...
     */
    @Override
    public int countByG_I(long groupId, long InitAuditId)
        throws SystemException {
    ...
    public AuditReport updateImpl(
        ...
        if (isNew || !AuditReportModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((auditReportModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] {
                        auditReportModelImpl.getOriginalGroupId(),
                        auditReportModelImpl.getOriginalInitAuditId()
                    };
                ...
                args = new Object[] {
                        auditReportModelImpl.getGroupId(),
                        auditReportModelImpl.getInitAuditId()
                    };
