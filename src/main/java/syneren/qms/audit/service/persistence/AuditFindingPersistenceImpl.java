...
public class AuditFindingPersistenceImpl extends BasePersistenceImpl<AuditFinding>
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_P = new FinderPath(AuditFindingModelImpl.ENTITY_CACHE_ENABLED,
            AuditFindingModelImpl.FINDER_CACHE_ENABLED, AuditFindingImpl.class,
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_P = new FinderPath(AuditFindingModelImpl.ENTITY_CACHE_ENABLED,
            AuditFindingModelImpl.FINDER_CACHE_ENABLED, AuditFindingImpl.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_P",
            new String[] { Long.class.getName(), Long.class.getName() },
            AuditFindingModelImpl.GROUPID_COLUMN_BITMASK |
            AuditFindingModelImpl.PLANID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_G_P = new FinderPath(AuditFindingModelImpl.ENTITY_CACHE_ENABLED,
            AuditFindingModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_P",
            new String[] { Long.class.getName(), Long.class.getName() });
    private static final String _FINDER_COLUMN_G_P_GROUPID_2 = "auditFinding.groupId = ? AND ";
    private static final String _FINDER_COLUMN_G_P_PLANID_2 = "auditFinding.PlanId = ?";
     ...
     */
    @Override
    public List<AuditFinding> findByG_P(long groupId, long PlanId)
        throws SystemException {
        return findByG_P(groupId, PlanId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
            null);
    }
     ...
     */
    @Override
    public List<AuditFinding> findByG_P(long groupId, long PlanId, int start,
        int end) throws SystemException {
        return findByG_P(groupId, PlanId, start, end, null);
    }
    ...
    public List<AuditFinding> findByG_P(long groupId, long PlanId, int start,
        ...
        if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
            ...
            finderArgs = new Object[] { groupId, PlanId };
        } else {
        ...
        if (list == null) {
            ...
            query.append(_FINDER_COLUMN_G_P_PLANID_2);
     ...
     */
    @Override
    public AuditFinding findByG_P_First(long groupId, long PlanId,
        OrderByComparator orderByComparator)
        throws NoSuchAuditFindingException, SystemException {
        AuditFinding auditFinding = fetchByG_P_First(groupId, PlanId,
                orderByComparator);
     ...
     */
    @Override
    public AuditFinding fetchByG_P_First(long groupId, long PlanId,
        OrderByComparator orderByComparator) throws SystemException {
        List<AuditFinding> list = findByG_P(groupId, PlanId, 0, 1,
                orderByComparator);
     ...
     */
    @Override
    public AuditFinding findByG_P_Last(long groupId, long PlanId,
        OrderByComparator orderByComparator)
        throws NoSuchAuditFindingException, SystemException {
        AuditFinding auditFinding = fetchByG_P_Last(groupId, PlanId,
                orderByComparator);
     ...
     */
    @Override
    public AuditFinding fetchByG_P_Last(long groupId, long PlanId,
        OrderByComparator orderByComparator) throws SystemException {
        int count = countByG_P(groupId, PlanId);

        if (count == 0) {
            return null;
        }

        List<AuditFinding> list = findByG_P(groupId, PlanId, count - 1, count,
                orderByComparator);
     ...
     */
    @Override
    public AuditFinding[] findByG_P_PrevAndNext(long FindingId, long groupId,
        ...
        try {
            ...
            array[0] = getByG_P_PrevAndNext(session, auditFinding, groupId,
                    PlanId, orderByComparator, true);

            array[1] = auditFinding;

            array[2] = getByG_P_PrevAndNext(session, auditFinding, groupId,
    ...
    protected AuditFinding getByG_P_PrevAndNext(Session session,
        AuditFinding auditFinding, long groupId, long PlanId,
        OrderByComparator orderByComparator, boolean previous) {
        StringBundler query = null;
     ...
     */
    @Override
    public void removeByG_P(long groupId, long PlanId)
        throws SystemException {
        for (AuditFinding auditFinding : findByG_P(groupId, PlanId,
                QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
            remove(auditFinding);
        }
    }
     ...
     */
    @Override
    public int countByG_P(long groupId, long PlanId) throws SystemException {
        FinderPath finderPath = FINDER_PATH_COUNT_BY_G_P;

        Object[] finderArgs = new Object[] { groupId, PlanId };
    ...
    public AuditFinding updateImpl(
        ...
        if (isNew || !AuditFindingModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((auditFindingModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] {
                        auditFindingModelImpl.getOriginalGroupId(),
                        auditFindingModelImpl.getOriginalPlanId()
                    };
                ...
                args = new Object[] {
                        auditFindingModelImpl.getGroupId(),
                        auditFindingModelImpl.getPlanId()
                    };
